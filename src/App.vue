            ...
            <button @click="openMenu = !openMenu" :class="openMenu ? 'bg-[#282828]' : 'bg-black'"
                ...
                <div class="flex items-center">
                    <img 
                      class="rounded-full" 
                      width="27"
                      src="https://yt3.ggpht.com/yti/ADpuP3PMCQmBjzlEboxaEsoCQ5jnxpBKJsFSaY32GzYwkA=s88-c-k-c0x00ffffff-no-rj-mo"
                    >
                    <div class="text-white text-[14px] ml-1.5 font-semibold">Jay Prajapati</div>
